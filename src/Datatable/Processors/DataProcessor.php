...
namespace Idsign\Vuetify\Datatable\Processors;
 ...
 * Class DataProcessor.
 *
 * @package Idsign\Vuetify\Datatable\Processors
...
class DataProcessor
{
    ...
    protected function escapeColumns(array $output)
    {
        return array_map(function ($row) {
            if ($this->escapeColumns == '*' && $this->rawColumns != '*') {
                $row = $this->escapeRow($row);
            } elseif (is_array($this->escapeColumns) && is_array($this->rawColumns)) {
