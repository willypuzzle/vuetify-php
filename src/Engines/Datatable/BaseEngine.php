...
use Idsign\Vuetify\Datatable\Contracts\KendoGridEngineContract;
...
abstract class BaseEngine implements KendoGridEngineContract
{
    ...
    protected function render($object = false)
    {
        ...
        if (isset($this->transformer)) {
            $fractal = app('vuetify_datatable.fractal');
    ...
    {
        return !!config('vuetify_datatable.search.case_insensitive', false);
    }
    ...
    {
        config(['vuetify_datatable.search.smart' => $bool]);
    ...
    {
        return !!config('vuetify_datatable.search.smart', true);
    }
    ...
    {
        return !!config('vuetify_datatable.search.use_wildcards', false);
    }
